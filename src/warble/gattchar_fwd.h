 ...
 */
typedef void(*Void_VoidP_WarbleGattCharP_CharP)(void* context, WarbleGattChar* caller, const char* value);
/**
 ...
 */
typedef void(*Void_VoidP_WarbleGattCharP_UbyteP_Ubyte)(void* context, WarbleGattChar* caller, const WARBLE_UBYTE* value, WARBLE_UBYTE length);
/**
 ...
 */
typedef void(*Void_VoidP_WarbleGattCharP_UbyteP_Ubyte_CharP)(void* context, WarbleGattChar* caller, const WARBLE_UBYTE* value, WARBLE_UBYTE length, const char* value2);