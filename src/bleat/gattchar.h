...
BLEAT_API void bleat_gattchar_write_async(BleatGattChar* obj, const uint8_t* value, uint8_t len, void* context, Void_VoidP_BleatGattCharP handler);
BLEAT_API void bleat_gattchar_write_without_resp_async(BleatGattChar* obj, const uint8_t* value, uint8_t len, void* context, Void_VoidP_BleatGattCharP handler);
